...
export default {
  ...
  methods: {
    ...
    gather () {
      ...
      this.form.shipper = `address: ${edo.shipper_address}, email: ${edo.shipper_email}, name: ${edo.shipper_name}`
      this.form.consignee = `address: ${edo.consignee_address}, email: ${edo.consignee_email}, name: ${edo.consignee_name}`
      this.form.notify_party = `notify: ${edo.notify}, notify address: ${edo.notify_address}`
      this.form.loading = edo.port_of_loading
      this.form.receipt = edo.place_of_receipt
      this.form.discharge = edo.port_of_discharges
      this.form.seal_number = edo.container_seal_number
      this.form.measurement = edo.measurement
      this.form.gross_weight = edo.gross_weight
