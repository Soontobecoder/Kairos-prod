<template>
  ...
  <v-container class="mx-auto px-md-5">
    ...
    >
      ...
      <v-tab class="mr-12">Data Branch Office</v-tab>
      ...
      >
        ...
        >
          ...
          >
            ...
            <!-- dialog bikin data branch office -->
            <v-dialog
              v-model="dialogBF"
              persistent
              max-width="1200px"
        ...
        <v-row>
          ...
          >
            <v-data-table
              :headers="data_branch_office"
              :items="body_branch_office"
              :page.sync="pageBF"
              :search="searchBF"
              hide-default-footer
              :items-per-page="itemsPerPage"
              @page-count="pageCountBF   = $event"
            >
              <template v-slot:[`item.status`]="{ item }">
                <v-card-text
                  v-if="item.status === 'active'"
              ...
              <template v-slot:[`item.actions`]="{ item: { id } }">
                <v-dialog
                  v-model="dialogDataBranchOffice"
                  persistent
                  :retain-focus="false"
                  max-width="1200px"
                >
...
export default {
  ...
  data () {
    return {
      ...
      // id for updating and getting by id
      id: 0
    }
  },
