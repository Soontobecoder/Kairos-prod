              ...
              >
                <template v-slot:activator="{ on, attrs }">
                  <v-btn 
                    ...
                    elevation="1"
                    v-bind="attrs"
                    :disabled="disabled === 0 || form.status === 'executed'"
                    v-on="on"
                    color="warning"
                  >
                    ...
                    >
                      ...
                      >
                        <v-list-item three-line>
                          <v-list-item-content>
                            <v-form
                              @submit.prevent="createInvoice(form.quo_number)"
                            >
                              <v-card-title>
                                ...
                                <v-row>
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      >
                                        <v-card-text
                                          style="font-size:16px; opacity:0; padding:0"
                                        >
                                          DIVIDER
                                        </v-card-text>
                                        <v-select
                    ...
                    >
                      ...
                      >
                        <v-list-item three-line>
                          <v-list-item-content>
                            <v-form
                              @submit.prevent="createPR(form.quo_number)"
                            >
                              <v-card-title>
                                <v-icon style="color:#3273dc;">mdi-file-document</v-icon><span class="headline" style="color:#3273dc;">Data Cost</span>
                              </v-card-title>
    ...
    async deleteI () {
      try {
        ...
        if (response.status === 200) {
          ...
          this.getById()
          this.$toast.global.app_success(`Successfuly deleted invoice for this quotation`)
        }
      } catch (error) {
        const response = error.response.data
        const message =
    ...
    async deletePR () {
      try {
        ...
        if (response.status === 200) {
          ...
          this.getById()
          this.$toast.global.app_success(`Successfuly deleted pay request for this quotation`)
        }
      } catch (error) {
        const response = error.response.data
        const message =
